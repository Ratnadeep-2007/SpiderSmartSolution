...
| **Dynamic Compliance Advisor** | AI Upgrade | RAG-based legal compliance advisor checking federal/state retention schedules with Gemini LLM, pgvector semantic search, UAE/GCC policy knowledge base, and citation cards. | **[DONE]** | `compliance_service.py`, `routers/compliance.py`, `ComplianceAdvisor.tsx`, `compliance_migration.sql` |
